...
{
    int returnAux = -1;
    Node* nodoBorrar = getNode(this, index);
...
int ll_indexOf(LinkedList* this, void* pElement)
{
    ...
    int len = ll_len(this);
    if(len>=1)              //si len es mayor a 1 significa que se valido que this != NULL
    {
...
{
    void* returnAux = ll_get(this, index); //tanto en returnAux como en ll_remove valido que this!=NULL
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    int len = ll_len(this);
    if(this!=NULL && from >= 0 && to <= len && from <= len && from < to)
    {
...
{
    LinkedList* cloneArray = ll_subList(this, 0, ll_len(this));
...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*),  int order)
{
    ...
    int len = ll_len(this);
    void* aux;
    if(this!=NULL && pFunc!=NULL && 0 <= order && order <= 1)
    {
...
LinkedList* ll_map (LinkedList* this, void*(*pFunc) (void* element))
{
    ...
    if(pFunc != NULL && this != NULL)
    {
        ...
        if(listaNueva!=NULL)
        {
            ...
            {
                pElement = ll_get(this, i);
                pElementNuevo = pFunc(pElement);
                ll_add(listaNueva, pElementNuevo);
            }
        }
